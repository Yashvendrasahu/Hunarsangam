...
class TopHeaderBar extends StatelessWidget {
  ...
  static const Color _primaryBorderColor = Color(0xFFE5D5CB);
  static const Color _chipBackgroundColor = Color(0xFFF3E7DF);
  static const Color _accentGreenColor = Color(0xFF2E7D32);
  static const Color _headerTextColor = Color(0xFF4A3B32);
  static const Color _mutedTextColor = Color(0xFF6E5D53);
